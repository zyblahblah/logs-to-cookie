...
def _sort_per_source(
    ...
    """Flat per-victim layout (keywords are filters, not folders)::
        ...
        out_dir/
          <victim>/
            cookies.txt   # all keyword-matching cookies for this victim
            creds.txt     # all keyword-matching creds for this victim

    Only victims with at least one match are written.
    """
    out_dir.mkdir(parents=True, exist_ok=True)
